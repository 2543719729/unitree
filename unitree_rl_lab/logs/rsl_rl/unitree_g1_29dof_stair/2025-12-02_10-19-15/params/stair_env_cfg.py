...
class StairSceneCfg(InteractiveSceneCfg):
    ...
    height_scanner = RayCasterCfg(
        ...
        offset=RayCasterCfg.OffsetCfg(pos=(0.2, 0.0, 0.8)),  # 略微前移，更好感知前方楼梯
        ray_alignment="yaw",
...
class StairRewardsCfg:
    ...
    核心变化:
    1. 新增 upward_progress: 鼓励向上攀爬
    2. 调整 base_height: 使用相对高度，不惩罚爬升
    3. 增大 feet_clearance 目标高度，适应楼梯
    """
    ...
    # ====================== 基座运动正则化 ======================
    base_linear_velocity = RewTerm(func=mdp.lin_vel_z_l2, weight=-1.0)  # 减小Z轴惩罚，允许爬升
    ...
    # ====================== 姿态奖励 ======================
    flat_orientation_l2 = RewTerm(func=mdp.flat_orientation_l2, weight=-3.0)  # 减小权重，允许前倾
    ...
    feet_clearance = RewTerm(
        ...
        params={
            "std": 0.05,
            "tanh_mult": 2.0,
            "target_height": 0.15,  # 提高到15cm，适应楼梯高度
            "asset_cfg": SceneEntityCfg("robot", body_names=".*ankle_roll.*"),
        },
    )
